...
module.exports = function(oApp) {
     ...
     */
    oApp.get("/statistics/evt-rev-by-month", function(oReq, oRes) {
        var sSql = "";
    });
     ...
     */
    oApp.get("/statistics/evt-rev-by-customer", function(oReq, oRes) {
     ...
     */
    oApp.get("/statistics/ce-rev", function(oReq, oRes) {
        var sSql = "SELECT " +
